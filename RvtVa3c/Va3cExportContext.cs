...
{
    // Hecho:
    // Comprobar la transformación de instancias
    // Transparencia de soporte
    // Agregar escala para Theo [(0,0), (20000,20000)]
    // Implementar el botón de aplicación externa
    // Implementar las propiedades del elemento
    // Eliminar múltiples materiales
    // Preguntar al usuario por el nombre y la ubicación del archivo de salida
    // Eliminar las propiedades del elemento nulo, es decir, inútil
    // Entradas de JSON userData
    // Que hacer:
    // Verificar el tamaño del archivo
    // Instancia / tipo de reutilización

    public class Va3cExportContext : IExportContext
    {
        /// <summary>
        /// Escala todo el nodo de objeto BIM de nivel superior en JSON
        /// salida. Una escala de 1.0 generará el modelo en
        /// milímetros. Actualmente lo escalamos a decímetros
        /// para que un modelo típico tenga la oportunidad de ajustarse
        /// en un cubo con una longitud lateral 100, es decir, 10 metros.
        /// </summary>
        double _scale_bim = 1.0;

        /// <summary>
        /// Escala aplicada a cada vértice en cada individuo
        /// elemento BIM. Esto se puede usar para escalar el modelo
        /// abajo de milímetros a metros, p. ej.
        /// Actualmente nos quedamos con milímetros después de todo
        /// en este nivel.                                     
        /// </summary>
        double _scale_vertex = 1.0;

        /// <summary>
        /// Si es verdadero, cambie las coordenadas Y y Z y cambie X a negativo 
        /// para convertir desde el sistema de coordenadas de Revit al sistema 
        /// de coordenadas de gráficos de computadora estándar en 3D con Z
        /// señalando fuera de la pantalla, X hacia la derecha,
        /// Y hacia arriba.
        /// </summary>
        bool _switch_coordinates = true;

        #region VertexLookupXyz - BUSQUEDAD DE VERTICES
        /// <summary>
        /// Una clase de búsqueda de vértices para 
        /// eliminar definiciones duplicadas de vértices.
        /// </summary>
        class VertexLookupXyz : Dictionary<XYZ, int>
        {
            #region XyzEqualityComparer - COMPARADOR DE IGUALDAD
            /// <summary>
            /// Defina la igualdad para los puntos de Revit XYZ.
            /// Tolerancia muy aproximada, como la utilizada por Revit.
            /// </summary>
            ...
            /// <summary>
            /// Devuelve el índice del vértice dado, 
            /// agregando una nueva entrada si es necesario.
            /// </summary>
        ...
        #region VertexLookupInt - BUSQUEDA DE VERTICES INTERNOS
        /// <summary>
        /// Una clase de puntos 3D basada en enteros.
        /// </summary>
        class PointInt : IComparable<PointInt>
        {
            ...
            /// <summary>
            /// Considere una longitud de Revit cero si es menor que esto.
            /// </summary>
            const double _eps = 1.0e-9;

            /// <summary>
            /// Factor de conversión de pies a milímetros.
            /// </summary>
            const double _feet_to_mm = 25.4 * 12;

            /// <summary>
            /// Conversión de un valor de longitud dado de pies a milímetros.
            /// </summary>
        ...
        /// <summary>
        /// Una clase de búsqueda de vértices
        /// para eliminar definiciones duplicadas de vértices.
        /// </summary>
        ...
        void SetCurrentMaterial(string uidMaterial)
        {
            ...
            {
                Material material = _doc.GetElement(uidMaterial) as Material;

                Va3cContainer.Va3cMaterial m = new Va3cContainer.Va3cMaterial();
        ...
        public void Finish()
        {
            ...
            Formatting formatting = UserSettings.JsonIndented
                ? Formatting.Indented
                : Formatting.None;

            myjs = JsonConvert.SerializeObject(_container, formatting, settings);
      ...
      return JsonConvert.SerializeObject( jason );
        ...
        public void OnMaterial(MaterialNode node)
        {
            ...
            else
            {
                ...
                // Genere un GUID basado en color, transparencia,
                // etc. para evitar la duplicación de definiciones de 
                // materiales que no sean elementos.
        ...
        {
            // Este método se invoca muchas veces 
        ...
        public void OnElementEnd(ElementId id)
        {
            ...
            Dictionary<string, string> d = Util.GetElementFilteredProperties(e, false);
