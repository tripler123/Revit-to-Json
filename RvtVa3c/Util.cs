...
namespace RvtVa3c
{
    class Util
    {
        ...
        /// <summary>
        ///Devuelve una cadena para un punto o vector 
        ///XYZ con sus coordenadas formateadas 
        ///con dos decimales.
        /// </summary>
        ...
        /// element parameter names and values.
        /// </summary>
        public static Dictionary<string, string>  GetElementFilteredProperties( Element e, bool includeType)
        {
            IList<Parameter> parameters = e.GetOrderedParameters();
